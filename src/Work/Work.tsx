        ...
        <div className="section grid-items work">
            ...
            <div className="section-content section-work">
                <div className="half">
                    ...
                    <a href="https://ictech.se/" className="work-place section-hover ictech">
                    ...
                    <a href="https://www.wirelesscar.com/" className="work-place section-hover wireless-car">
                ...
                <a href="https://www.tibco.com/products/tibco-spotfire" className="work-place section-hover tibco">
