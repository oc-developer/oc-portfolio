    ...
    return (
        <Link to="/">
            <svg className="mini-logo" width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path className="logo-d" fillRule="evenodd" clipRule="evenodd" d="M17 43V41H47V43C47 49.0751 42.0751 54 36 54H28C21.9249 54 17 49.0751 17 43ZM17 36H47H52V43C52 51.8366 44.8366 59 36 59H28C19.1634 59 12 51.8366 12 43V36H17Z" fill="black" />
