    ...
    return (
        <div className="protagonist-tab">
            <svg className="tab logo" width="1024" height="1024" viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path className="logo-letter logo-d" fillRule="evenodd" clipRule="evenodd" d="M272 623V696C272 793.202 350.798 872 448 872H576C673.202 872 752 793.202 752 696V623H832V696C832 837.385 717.385 952 576 952H448C306.615 952 192 837.385 192 696V623H272Z" fill="black" />
                <line className="logo-line" x1="271" y1="624" x2="753" y2="624" stroke="black" strokeWidth="80" />
                <path className="logo-letter logo-c" fillRule="evenodd" clipRule="evenodd" d="M448 392H576C673.202 392 752 470.798 752 568V623H832V568C832 426.615 717.385 312 576 312H448C306.615 312 192 426.615 192 568V623H272V568C272 470.798 350.798 392 448 392Z" fill="black" />
