    ...
    return (
        <div className="protagonist-tab fade-in">
            <svg className="tab logo" width="1024" height="1024" viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <line x1="272" y1="624" x2="752" y2="624" stroke="black" strokeWidth="80" />
                <path fillRule="evenodd" clipRule="evenodd" d="M448 392H576C673.202 392 752 470.798 752 568V623H832V568C832 426.615 717.385 312 576 312H448C306.615 312 192 426.615 192 568V623H272V568C272 470.798 350.798 392 448 392Z" fill="black" />
